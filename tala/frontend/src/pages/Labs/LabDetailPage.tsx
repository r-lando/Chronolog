...
import { FindingsSection } from "../../components/evidence/FindingsSection";
import { useLabEvidence, useLabFindings } from "../../hooks/useEvidence";
...
export function LabDetailPage() {
  ...
  const { data: labEvidence } = useLabEvidence(id);
  const { data: labFindings } = useLabFindings(id);
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="card p-6 mb-6">
        <h2 className="text-lg font-semibold text-slate-100 mb-4">Findings</h2>
        <FindingsSection labId={lab.id} />
      </div>
      ...
      <div className="card p-6 mb-6">
        ...
        <div className="mb-4">
          <EvidenceUploadForm labId={lab.id} findings={labFindings ?? []} />
        </div>
        <EvidenceList labId={lab.id} evidence={labEvidence ?? []} />
      </div>
